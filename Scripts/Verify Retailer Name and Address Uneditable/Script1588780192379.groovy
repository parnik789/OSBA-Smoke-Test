...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Edit - OSBA Administration Portal/input_Postcode_Postcode'), 
    '')

WebUI.click(findTestObject('Page_Edit - OSBA Administration Portal/a_Email  Phone'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementText(findTestObject('Object Repository/Page_Edit - OSBA Administration Portal/input_Customer Contact Email Address_Custom_79a1c8'), 
    '')

WebUI.verifyElementText(findTestObject('Object Repository/Page_Edit - OSBA Administration Portal/input_Booking Notification Email Address_Re_78bbea'), 
    '')

WebUI.verifyElementText(findTestObject('Object Repository/Page_Edit - OSBA Administration Portal/input_Booking Notification Email Address_Re_78bbea'), 
    '')

WebUI.click(findTestObject('Page_Edit - OSBA Administration Portal/button_Save'))
